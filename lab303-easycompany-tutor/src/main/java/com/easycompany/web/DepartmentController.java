...
public class DepartmentController {
	...
	public String getDepartmentList(@CommandMap Map<String, String> commandMap, ModelMap model){
	...
	public String getSubDepartmentList(@CommandMap Map<String, String> commandMap, ModelMap model){
