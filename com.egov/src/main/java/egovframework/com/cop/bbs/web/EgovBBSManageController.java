...
public class EgovBBSManageController {
	...
	public String selectBoardArticles(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		log.debug(this.getClass().getName() + " => propertyService : " + propertyService);
		log.debug(this.getClass().getName() + "    => " + propertyService.getKeys());
		log.debug(this.getClass().getName() + "    => " + propertyService.getAllKeyValue());
		...
		log.debug(this.getClass().getName() + " => boardVO : " + boardVO);
	...
	public String replyBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("bdMstr") BoardMaster bdMstr,
		...
		log.debug(" ##### boardVO.getSortOrdr() : " + boardVO.getSortOrdr());
		log.debug(" ##### boardVO.getNttNo() : " + boardVO.getNttNo());
		...
		if (isAuthenticated) {
			...
			log.debug(" ##### board.getSortOrdr() : " + board.getSortOrdr());
			log.debug(" ##### board.getNttNo() : " + board.getNttNo());
