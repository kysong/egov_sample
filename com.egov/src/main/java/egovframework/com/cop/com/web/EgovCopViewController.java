...
/*    @RequestMapping("/cop/cus/CmmntyViewPage.do")
    ...
    // http://localhost:8080/sample/cop/com/openPopup.do?requestUrl=/cop/tpl/selectTemplateInfsPop.do&typeFlag=BBS&width=850&height=360
    	log.debug(this.getClass().getName()+">>>> commandMap : "+commandMap);	
	...
	if (trgetId != null && trgetId != "") {
	    ...
	    log.debug(this.getClass().getName()+">>>>typeFlag  After : "+requestUrl + "?PopFlag=Y");	
